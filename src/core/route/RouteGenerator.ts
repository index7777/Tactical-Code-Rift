...
export function generateStoryRoute(random:()=>number=Math.random):StoryRoute{
  const branchA=random()<.5?'event':'exploration',branchB=branchA==='event'?'exploration':'event';
  const nodes:StoryRouteNode[]=[
    {id:'depart',column:0,lane:1,type:'departure',nextIds:['battle-1'],implemented:true},
    {id:'battle-1',column:1,lane:1,type:'battle',nextIds:['branch-a','branch-b'],implemented:true},
    {id:'branch-a',column:2,lane:0,type:branchA,nextIds:['battle-2'],implemented:false},
    {id:'branch-b',column:2,lane:2,type:branchB,nextIds:['companion-1'],implemented:false},
    {id:'battle-2',column:3,lane:0,type:'battle',nextIds:['elite-1'],implemented:true},
    {id:'companion-1',column:3,lane:2,type:'companion',nextIds:['elite-1'],implemented:false},
    {id:'elite-1',column:4,lane:1,type:'elite',nextIds:['boss-1'],implemented:true},
    {id:'boss-1',column:5,lane:1,type:'boss',nextIds:[],implemented:false},
  ];
