...
export interface EnemySkill{id:string;name:string;clashPower:number;damage:number;targetId:string;tempo?:number;unclashable?:boolean;assist?:boolean;balanceDamage?:number;archetype?:EnemyArchetype}
