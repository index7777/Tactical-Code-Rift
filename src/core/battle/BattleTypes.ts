...
export interface EnemySkill{id:string;name:string;clashPower:number;damage:number;targetId:string;unclashable?:boolean}
export interface ActionNode{id:string;team:Team;actorId:string;actorIndex:number;speed:number;order:number;enemySkill?:EnemySkill}
