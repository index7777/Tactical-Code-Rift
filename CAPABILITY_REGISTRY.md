...
AUTHORITATIVE_SOURCE_ROOTS = src, docs/PROJECT_STATUS.md, docs/ARCHITECTURE.md, docs/CURRENT_COMBAT_SPEC.md
TEST_ROOTS = src/**/*.test.ts
GENERATED_BUILD_VENDOR_ROOTS = build, dist, node_modules
```
