...
- Canonical verification: `npm run test`, `npm run build`, `git diff --check`.
...
3. Continue decomposing `BootScene`; named-player loading and encounter setup are now extracted.
